...
public class Controller
{
    ...
    public void embedMoveNumber(int currentRow, int currentColumn, boolean empty)
    {
        ...
        if (!empty)
        {
            //assign move number to text node
        ...
        {
            //remove text node from board square if a text node is present
            StackPane s = Main.getBoardSquare(Main.getBoard(), currentRow, currentColumn);
    ...
    public void nextValidMoves(int currentRow, int currentColumn)
    {
        ...
        embedMoveNumber(currentRow, currentColumn, false);
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            if (currentRowCopy >=1 && currentRowCopy < 8 && currentColumnCopy >=0 && currentColumnCopy < 8
    ...
    {
        Main.clear.setOnMouseClicked(mouseEvent -> {
            currentMoveNumber = 0;
            initializeBoard();
            clearHighlightedSquares();
