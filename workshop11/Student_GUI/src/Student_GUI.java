...
public class Student_GUI
{
    ...
    private static JTextArea results = new JTextArea( 8, 31);
        ...
        buttons[1].addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                try
                {
                    ...
                    storedData = ReadStudent.readStudentFromFile(null);
                }
    ...
    public static void constructUI()
    {
        ...
        sl.putConstraint(SpringLayout.WEST, textFields[0], 120, SpringLayout.WEST, panel);
        ...
        sl.putConstraint(SpringLayout.EAST, textFields[1], 120, SpringLayout.EAST, labels[1]);
        ...
        sl.putConstraint(SpringLayout.EAST, textFields[2], 120, SpringLayout.EAST, labels[2]);
        ...
        sl.putConstraint(SpringLayout.EAST, textFields[3], 122, SpringLayout.EAST, labels[3]);
        ...
        sl.putConstraint(SpringLayout.WEST, buttons[1], 145, SpringLayout.WEST, panel);
