...
{
    public static void saveStudentToFile(Student[] students, String filename ) throws IOException
    {
            //open file and object output stream to serialize Student object array to file
    ...
    public static void main(String[] args)
    {
        ...
        int numOfStudents = 0;
        Student[] serializedStudents = null;
        ...
        while(!validInput)
        {
            try
            {
                ...
                serializedStudents = new Student[numOfStudents];
                for (int studentCount = 0; studentCount < numOfStudents; studentCount++)
                {
                    ...
                    courses.clear();
                    //create and save student information into Student array
                    serializedStudents[studentCount] = getStudentInfo(studentInfoScanners, courses, studentCount + 1);
                }
